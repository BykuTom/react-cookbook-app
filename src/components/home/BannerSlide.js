...
export const BannerSlide = () => {
  const slidesData = [
    ...
    },
    {
      ...
      summary:
        "Lemon Parmesan Zucchini Noodles is a hor d'oeuvre that serves 4. One serving contains 56 calories, 3g of protein, and 4g of fat. For 24 cents per serving, this recipe covers 2% of your daily requirements of vitamins and minerals. 2 people were impressed by this recipe. From preparation to the plate, this recipe takes roughly 13 minutes. It is brought to you by Lifes Ambrosia. A mixture of melt rich & creamy, garlic, zucchini, and a handful of other ingredients are all it takes to make this recipe so tasty. It is a good option if you're following a gluten free diet.",
      rating: 4,
      image: lemonParmesan,
    },
  ];
